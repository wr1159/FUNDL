    ...
    const features = [
        {
            ...
            text: "State your goal amount, ERC20 token, end date and information on project.",
        },
        {
            title: "FUNDL",
            text: "Users fund the project with the specified token.",
        },
        {
            title: "Payment Streaming",
            text: "Payment is Streamed every block to the project owner until End of Project.",
        },
        {
            title: "Milestone Based System",
            text: "Payment Streaming Rate and Threshold is dependent on milestone.",
        },
        {
            title: "Boosting",
            text: "Project Creators can Boost projects for more visibility",
        },
        {
            title: "Voting-based Refund",
            text: " Users can vote to stop the project for refund in case of lack of activity from the project.",
        },
    ];
